...
export enum TauriCmd {
  ...
  ChannelListAccounts = "channel_list_accounts",
  ChannelGetActiveAccountId = "channel_get_active_account_id",
  ChannelSetActiveAccountId = "channel_set_active_account_id",
