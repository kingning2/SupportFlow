...
use crate::protocol::stream::executor::{AgentStreamExecutor, CallLlmError};
use crate::protocol::stream::helpers::hash_args;
use crate::protocol::stream::tools_exec::{format_tool_result_content, ToolExecutionResult};
use crate::protocol::AgentCancelledError;
...
fn log_tool_calls(tool_calls: &[crate::protocol::stream::executor::ParsedToolCall]) {
...
fn log_tool_result(
    tc: &crate::protocol::stream::executor::ParsedToolCall,
