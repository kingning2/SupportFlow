...
use crate::agent_event_handler::{make_event_callback, AgentEventHandler};
use crate::agent_initializer::{AgentInitOptions, AgentInitializer};
...
impl AgentBridge {
    ...
    pub fn refresh_all_skills(&self) -> usize {
        crate::config_sync::load_dotenv_into_process();
        let mut count = 0;
