# encoding:utf-8
"""Smoke test: hook running WeCom without calling open() twice. Run from channel_agent root:
  py -3.10 scripts/test_wework_hook.py
"""
import os
import sys
...
os.environ.setdefault("CHANNEL_CONFIG_PATH", os.path.join(ROOT, "..", "resources", "config.json"))
