        ...
        [
            ...
            (
                "wework",
                {
                    ...
                    "hint": {
                        "zh": "需 Windows + 企业微信 PC 版 4.0.8.6027；本机装多个版本时请填写 wework_exe_path。Python 3.8～3.10；pip install ntwork pilk。",
                        "en": "Windows + WeCom 4.0.8.6027; set wework_exe_path if multiple installs. Python 3.8–3.10; pip install ntwork pilk.",
                    },
                },
            ),
            (
